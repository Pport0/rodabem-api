    ...
    <View style={styles.historyCard}>
      ...
      <View style={styles.historyMetaRow}>
        ...
        <Text style={styles.historyMeta}>
          {formatCurrency(item.valorMinimoAntt)} ANTT
        </Text>
...
export default function FreteScreen() {
  ...
  const caminhao = caminhaoQuery.data;
  const hasNumeroEixos = !!caminhao?.numeroEixos;
  ...
  const summary = useMemo(() => {
    ...
    return [
      ...
      {
        label: 'Combustivel',
        value: formatCurrency(latestResult.custoCombustivel),
      },
      {
        label: 'Pedagios',
        value: formatCurrency(latestResult.pedagiosEstimados),
      },
    ];
  }, [latestResult]);
  ...
  const handleSubmit = () => {
    if (!caminhao) {
      Toast.show('Cadastre um caminhao antes de simular um frete.', {
        type: 'error',
        backgroundColor: '#E53E3E',
      });
      return;
    ...
    if (!hasNumeroEixos) {
      Toast.show(
        'Informe o numero de eixos do caminhao na tela de edicao antes de simular.',
        {
          type: 'error',
          backgroundColor: '#E53E3E',
        }
      ...
      <View style={[styles.heroCard, { backgroundColor: primaryColor }]}>
        <View style={styles.heroText}>
          ...
          <Text style={styles.heroTitle}>
            Simule custos, ANTT e retorno estimado.
          </Text>
        </View>
      ...
      {!hasNumeroEixos && (
        <View style={styles.warningCard}>
          <Text style={styles.warningCardTitle}>
            O caminhao precisa ter numero de eixos cadastrado.
          </Text>
          <Text style={styles.warningCardText}>
            Edite os dados do caminhao no perfil para liberar a simulacao.
          </Text>
        </View>
      )}
      ...
      <View style={styles.formCard}>
        ...
        <View style={styles.row}>
          <View style={[styles.fieldContainer, styles.flex]}>
            <Text style={[styles.label, styles.rowFieldLabel]}>
              PRECO COMBUSTIVEL (R$/L) *
            </Text>
            <Input
              placeholder="Ex: 6,29"
              value={precoCombustivel}
              onChangeText={(text) =>
                setPrecoCombustivel(text.replace(/[^0-9.,]/g, ''))
              }
          ...
          <View style={[styles.fieldContainer, styles.flex]}>
            ...
            <Input
              ...
              onChangeText={(text) =>
                setPedagiosManual(text.replace(/[^0-9.,]/g, ''))
              }
              keyboardType="decimal-pad"
            />
          </View>
        ...
        <View style={styles.fieldContainer}>
          ...
          <Input
            ...
            value={consumoManual}
            onChangeText={(text) =>
              setConsumoManual(text.replace(/[^0-9.,]/g, ''))
            }
            keyboardType="decimal-pad"
          />
        </View>
        ...
        <View style={styles.switchRow}>
          <View style={styles.switchTextGroup}>
            ...
            <Text style={styles.switchSubtitle}>
              Dobra distancia e pedagios para volta sem carga.
            </Text>
          </View>
          <Switch
            value={retornoVazio}
        ...
        <View style={styles.switchRow}>
          <View style={styles.switchTextGroup}>
            ...
            <Text style={styles.switchSubtitle}>
              Guarda a simulacao com essa classificacao.
            </Text>
          </View>
          <Switch
        ...
        <View style={styles.resultCard}>
          ...
          <View style={styles.detailLine}>
            ...
            <Text style={styles.detailValue}>
              {formatCurrency(latestResult.valorMinimoAntt)}
            </Text>
          </View>
          <View style={styles.detailLine}>
            <Text style={styles.detailLabel}>Litros necessarios</Text>
            <Text style={styles.detailValue}>
              {latestResult.litrosNecessarios.toFixed(2)} L
            </Text>
          </View>
          <View style={styles.detailLine}>
            <Text style={styles.detailLabel}>Consumo usado</Text>
            <Text style={styles.detailValue}>
              {latestResult.consumoMedioKmL.toFixed(2)} km/L
            </Text>
          </View>

          {!!latestResult.aviso && (
            <Text style={styles.warningText}>{latestResult.aviso}</Text>
          )}
        </View>
      )}
        ...
        {historicoQuery.data?.length ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              A primeira simulacao aparecera aqui.
            </Text>
          </View>
        )}
      </View>
